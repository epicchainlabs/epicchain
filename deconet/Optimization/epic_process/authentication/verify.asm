...
section .data
    ...
    verification_success_msg db "Verification successful!", 0 ; Success message
    verification_failure_msg db "Verification failed. Invalid username or password.", 0 ; Failure message

section .text
    global verify_identity
...
check_username_loop:
    ...
    jne .verification_failed ; If they don't match, jump to verification_failed
    ...
    ; Now, check if the entered password matches the predefined password
