...
//
// UT_TransactionManager.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
namespace EpicChain.Network.RPC.Tests
{
    ...
    public class UT_TransactionManager
    {
        ...
        {
            var mockRpc = new Mock<RpcClient>(MockBehavior.Strict, new Uri("http://mainnet1-seed.epic-chain.org:10112"), null, null, null);
