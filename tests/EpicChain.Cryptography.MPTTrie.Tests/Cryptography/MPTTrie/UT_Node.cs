...
//
// UT_Node.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
namespace EpicChain.Cryptography.MPTTrie.Tests
{
    ...
    public class UT_Node
    {
        private byte[] NodeToArrayAsChild(Node n)
        {
            ...
            using var writer = new BinaryWriter(ms, EpicChain.Utility.StrictUTF8, true);
