...
namespace EpicChain.UnitTests.SmartContract
{
    ...
    public class UT_Helper
    {
        ...
        public void TestGetContractHash()
        {
            ...
            Assert.AreEqual("0x9b9628e4f1611af90e761eea8cc21372380c74b6", EpicChain.SmartContract.Helper.GetContractHash(UInt160.Zero, nef.CheckSum, "").ToString());
            Assert.AreEqual("0x66eec404d86b918d084e62a29ac9990e3b6f4286", EpicChain.SmartContract.Helper.GetContractHash(UInt160.Parse("0xa400ff00ff00ff00ff00ff00ff00ff00ff00ff01"), nef.CheckSum, "").ToString());
        }
        ...
        public void TestSignatureContractCost()
        {
            ...
            invocationScript.EmitPush(EpicChain.Wallets.Helper.Sign(tx, _key, TestProtocolSettings.Default.Network));
            ...
            Assert.AreEqual(EpicChain.SmartContract.Helper.SignatureContractCost() * CovenantChain.DefaultExecFeeFactor, engine.FeeConsumed);
        }
        ...
        public void TestMultiSignatureContractCost()
        {
            ...
            Assert.AreEqual(EpicChain.SmartContract.Helper.MultiSignatureContractCost(1, 1) * CovenantChain.DefaultExecFeeFactor, engine.FeeConsumed);
        }
    }
}
