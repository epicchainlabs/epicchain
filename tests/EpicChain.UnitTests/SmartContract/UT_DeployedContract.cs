...
namespace EpicChain.UnitTests.SmartContract
{
    ...
    public class UT_DeployedContract
    {
        ...
        public void TestGetScriptHash()
        {
            ...
            {
                Manifest = new EpicChain.SmartContract.Manifest.ContractManifest()
                {
                    Abi = new EpicChain.SmartContract.Manifest.ContractAbi()
                    {
                        Methods = new EpicChain.SmartContract.Manifest.ContractMethodDescriptor[]
                         {
                             new EpicChain.SmartContract.Manifest.ContractMethodDescriptor()
                             {
                                  Name = "verify",
                                  Parameters = Array.Empty<EpicChain.SmartContract.Manifest.ContractParameterDefinition>()
                             }
                         }
                    }
                },
