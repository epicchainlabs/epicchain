...
namespace EpicChain.UnitTests.SmartContract
{
    public partial class UT_ApplicationEngine
    {
        ...
        public void TestGetNetworkAndAddressVersion()
        {
            ...
            using var engine = ApplicationEngine.Create(TriggerType.Application, tx, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
        ...
        {
            using var engine = ApplicationEngine.Create(TriggerType.Application, null, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
        ...
        public void TestGetRandomSameBlock()
        {
            ...
            using var engine_1 = ApplicationEngine.Create(TriggerType.Application, tx, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
            using var engine_2 = ApplicationEngine.Create(TriggerType.Application, tx, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
        ...
        public void TestGetRandomDifferentBlock()
        {
            ...
            using var engine_1 = ApplicationEngine.Create(TriggerType.Application, tx_1, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
            // The next_nonce shuld be reinitialized when a new block is persisting
            using var engine_2 = ApplicationEngine.Create(TriggerType.Application, tx_2, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
        ...
        {
            var tx_1 = TestUtils.GetTransaction(UInt160.Zero);
            using var engine = ApplicationEngine.Create(TriggerType.Application, tx_1, null, TestBlockchain.TheEpicChainSystem.GenesisBlock, settings: TestBlockchain.TheEpicChainSystem.Settings, epicpulse: 1100_00000000);
            var msg = new byte[]
            {
