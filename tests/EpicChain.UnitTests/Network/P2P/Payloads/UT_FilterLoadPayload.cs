...
//
// UT_FilterLoadPayload.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
namespace EpicChain.UnitTests.Network.P2P.Payloads
{
    ...
    public class UT_FilterLoadPayload
    {
        ...
        public void Size_Get()
        {
            ...
            test = FilterLoadPayload.Create(new EpicChain.Cryptography.BloomFilter(8, 10, 123456));
        ...
        {
            var test = FilterLoadPayload.Create(new EpicChain.Cryptography.BloomFilter(8, 10, 123456));
