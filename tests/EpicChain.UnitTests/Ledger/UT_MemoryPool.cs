...
//
// UT_MemoryPool.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
namespace EpicChain.UnitTests.Ledger
{
    ...
    public class UT_MemoryPool : TestKit
    {
        ...
        public void TestSetup()
        {
            ...
            _unit = new MemoryPool(new EpicChainSystem(TestProtocolSettings.Default with { MemoryPoolMaxTransactions = 100 }, storageProvider: (string)null));
        ...
        {
            _unit = new MemoryPool(new EpicChainSystem(TestProtocolSettings.Default with { MemoryPoolMaxTransactions = 600 }, storageProvider: (string)null));
