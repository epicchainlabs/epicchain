...
namespace EpicChain.UnitTests.Wallets
{
    ...
    public class UT_AssetDescriptor
    {
        ...
        public void TestConstructorWithNonexistAssetId()
        {
            ...
            Action action = () =>
            {
                var descriptor = new EpicChain.Wallets.AssetDescriptor(snapshotCache, TestProtocolSettings.Default, UInt160.Parse("01ff00ff00ff00ff00ff00ff00ff00ff00ff00a4"));
            };
        ...
        {
            var snapshotCache = TestBlockchain.GetTestSnapshotCache();
            var descriptor = new EpicChain.Wallets.AssetDescriptor(snapshotCache, TestProtocolSettings.Default, NativeContract.EpicPulse.Hash);
        ...
        {
            var snapshotCache = TestBlockchain.GetTestSnapshotCache();
            var descriptor = new EpicChain.Wallets.AssetDescriptor(snapshotCache, TestProtocolSettings.Default, NativeContract.EpicChain.Hash);
            descriptor.AssetId.Should().Be(NativeContract.EpicChain.Hash);
