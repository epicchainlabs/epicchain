...
//
// UT_ECPoint.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
using ECCurve = EpicChain.Cryptography.ECC.ECCurve;
using ECPoint = EpicChain.Cryptography.ECC.ECPoint;

namespace EpicChain.UnitTests.Cryptography.ECC
{
    [TestClass]
