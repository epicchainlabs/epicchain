...
/// <summary>
/// Defines the total amount of gas distributed during the initialization of the network.
/// Gas serves as the unit of measure for transaction fees and computational resources used
/// during smart contract execution. The initial gas distribution ensures that network participants
/// have a sufficient supply to conduct transactions and interact with contracts, fostering early network activity.
/// Gas is denominated in datoshi, where 1 EpicPulse equals 1e8 datoshi. This distribution is important
