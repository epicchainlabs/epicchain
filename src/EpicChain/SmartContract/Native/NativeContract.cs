...
//
// NativeContract.cs is a component of the EpicChain Labs project, founded by xmoohad. This file is
...
namespace EpicChain.SmartContract.Native
{
    ...
    public abstract class NativeContract
    {
        ...
        {
            UInt160 committeeMultiSigAddr = EpicChain.GetCommitteeAddress(engine.SnapshotCache);
